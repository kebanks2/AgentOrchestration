"""Authentication and authorization helpers for operator API actions."""
...
def extract_operator_token(request: Request) -> Optional[str]:
...
def require_operator_permission(
    ...
    require_workspace_role(principal, workspace_id, allowed_roles)
